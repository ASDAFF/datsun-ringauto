    ...
    <div class="content">
        <div class="news-detail">
            ...
            <div class="news-cont">
                ...
                <p>
                    CTK CENTER осуществляет весь спектр работ в области слесарного ремонта автомобилей Datsun с целью устранения неисправностей и поддержания их надежной работоспособности. Станция технического обслуживания площадью 813 кв. м оборудована прозрачными стенами, благодаря чему Вы можете наблюдать за тем, как специалисты CTK CENTER проводят работы по сервисному обслуживанию Вашего автомобиля. <br>
                </p>
                ...
                <p>
                    Кузовная станция CTK CENTER выполняет ремонт автомобиля любой сложности: от устранения мелких косметических повреждений до полного восстановления геометрии кузова. Окрасочные работы осуществляются с использованием самых современных технологий и материалов. Малярно-кузовной цех площадью 716 кв.м способен обслуживать за смену около 40 автомобилей. В случае необходимости специалисты CTK CENTER выполнят кузовные работы качественно и в максимально короткие сроки. <br>
                </p>
                ...
                <p>
                    Мы сотрудничаем с ведущими Страховыми компаниями РФ, работающими в Санкт-Петербурге. <b>Чтобы ускорить выполнение кузовного ремонта, Вы можете прислать направление от страховой компании, свидетельство о регистрации ТС, фотографии повреждений и контактную информацию на электронный адрес:</b> <a href="mailto:uuu@ctk-center.ru"><b>uuu@ctk-center.ru</b></a>
                </p>
                <p>
                </p>
                <div class="news-subtitle">
            ...
            <div class="news-subtitle">
                УСЛУГА УДАЛЕННОГО УРЕГУЛИРОВАНИЯ УБЫТКОВ
            </div>
            <p>
                Услуга предоставляется владельцем автомобилей Datsun, являющихся клиентом страховых компаний, с которыми сотрудничает CTK CENTER, по договору (полису) добровольного страхования транспортных средств (КАСКО). <b>Данная услуга является бесплатной при условии дальнейшего ремонта застрахованного транспортного средства в CTK CENTER по направлению страховой компании.</b>
            </p>
            <br>
        </div>
