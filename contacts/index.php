...
?>
    ...
    <div class="content">
        ...
        <div class="form-fancybox-modal backform">
            ...
            <form name="SIMPLE_FORM_2" action="/contacts/" method="POST" enctype="multipart/form-data"><input type="hidden" name="sessid" id="sessid" value="1656cf339a9aaccf0709748850691180" /><input type="hidden" name="WEB_FORM_ID" value="2" />
                <label>
                    <div class="label"><p>Имя<span class="required">*</span></p></div>
                    <input type="text"  class="inputtext"  name="form_text_4" value="" size="0" / required>			</label>
                <label>
                    <div class="label"><p>Телефон<span class="required">*</span></p></div>
                    <input type="text"  class="inputtext"  name="form_text_5" value="" size="0" / required>			</label>
                <label>
                    <div class="label"><p>Комментарий</p></div>
                    <textarea name="form_textarea_6" cols="40" rows="5"  class="inputtextarea" ></textarea>			</label>
