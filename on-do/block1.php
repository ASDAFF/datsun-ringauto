...
<div class="bubble-m">Выгода <span>по программе утилизации </span>50 000 <span>руб.</span></div>
<div class="slider-links-m">
    <a class="item form-fancybox" href="#signUpForATestDrive">Записаться на тест-драйв</a>
    <a class="item form-fancybox" href="#handOverInOffset">Сдать а/м в зачет</a>
    <a class="item form-fancybox" href="#calculateLoan">Рассчитать кредит</a>
    <a class="item red" href="/cars/in_stock/?arrFilter_77=1146786818&arrFilter_87=&set_filter=НАЙТИ" onClick="ga('send', 'pageview', {'page': 'button-click','title': 'Нажатие на кнопку'});">Автомобили в наличии</a>
</div>