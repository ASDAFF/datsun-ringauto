...
?>
    ...
    <div class="content">
        ...
        <div class="news-detail">
            ...
            <div class="news-cont">
                <p> <b>Планируете покупку автомобиля Datsun в кредит? Оформить его вы можете в Ринг Авто Север, где действуют самые выгодные программы на льготных условиях от производителя.</b> 		</p>
                ...
                <p> 			 Главной особенностью программы Datsun Finance является возможность приобрести полис автострахования ЛайтКАСКО по доступной цене. Теперь, чтобы получить кредит, Вам не нужно тратить свои средства на дорогостоящее страхование. Достаточно выбрать комфортный ежемесячный платеж и оформить кредит в дилерском центре Ринг Авто Север. 		</p>
