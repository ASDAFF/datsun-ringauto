        ...
        <div class="news-detail">
            ...
            <div class="news-cont">
                ...
                <ul>
                    ...
                    <li>гарантия <b>на оригинальные запасные части</b>, установленные в автосалоне CTK CENTER, — 1 год.</li>
                ...
                <hr>
                <p class="disclaimer"> 			<sup>*</sup> Цена действительна на 01.10.2015. Не является публичной офертой. Цена может быть изменена в одностороннем порядке. Текущую цену уточняйте по телефону (812) 336 91 20.</p>
            </div>
        </div>
