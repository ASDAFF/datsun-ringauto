...
<footer>
    <div class="footer-inner">
        ...
        <div class="footer-menu">
            <ul id="horizontal-multilevel-menu">
                ...
                <li><a href="/center" class="root-item">О компании</a>
                    <ul>
                        <li><a href="/center/">Ринг Авто Липецк</a></li>
        ...
        <div class="footer-subcsribe">
            ...
            <form name="SIMPLE_FORM_12" action="/" method="POST" enctype="multipart/form-data"><input type="hidden" name="sessid" id="sessid" value="4809d17c626e5aa24603c916574f94b9" /><input type="hidden" name="WEB_FORM_ID" value="12" />			<input class="form-control" type="email" name="form_email_54" id="subscribe_email" placeholder="Введите Ваш E-mail" required>
                <div class="form-i footer-_sub">
                    ...
                    <span class="agreement">Я даю свое согласие на обработку персональных данных, с <a href="/upload/personal2.docx">условиями обработки персональных данных</a> ознакомлен</span>
                </div>
        ...
        <div class="copyright">
			© 2017 ООО "Глобал Системз". Официальный дилер Datsun в Липецке. Информация, указанная на настоящем интернет-сайте, носит исключительно информационный характер и ни при каких условиях не является публичной офертой (ст. 437 ГК РФ). <a href="/upload/conf_politic2.docx" style="color:#fff">Политика конфиденциальности</a>. <a href="/upload/personal2.docx" style="color:#fff">Согласие на обработку персональных данных</a>.<br><br>
